...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/20 15:32:18 by cboutier          #+#    #+#             */
/*   Updated: 2021/12/22 13:54:56 by cboutier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_update_player_pos(t_total *total);
...
void			ft_fill_sprites_info(t_total *total, int *nb_visible_sprites,
					int i, t_sprite *visible_sprites);
void			ft_sort_sprites(int nb_visible_sprites,
					t_sprite *visible_sprites);
void			ft_get_texture_offset_x(t_total *total, int x,
					int *texture_offset_x, int i);
void			ft_fill_sprites_variables(t_total *total, int i,
					double perp_distance, double distance_proj_plane);

/* RENDER_SPRITES */

void			ft_draw_sprites(t_total *total, int x,
					int i, int j);
int				ft_render_sprites_proj(t_total *total);
void			ft_print_sprites(int nb_visible_sprites,
					t_sprite *visible_sprites, t_total *total,
