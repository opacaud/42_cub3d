...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/20 14:54:52 by cboutier          #+#    #+#             */
/*   Updated: 2021/12/21 09:45:26 by cboutier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_update_player_pos(t_total *total)
{
	...
	if (total->player->mouse_moving == 1)
	{
		total->player->mouse_moving = 0;
...
int	ft_mlx(t_total *total)
{
	...
	ft_render_sprites_proj(total);
	if (ft_print_mini_map(total))
		return (0);
